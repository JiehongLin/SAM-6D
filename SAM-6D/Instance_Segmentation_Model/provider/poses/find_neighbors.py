...
if __name__ == "__main__":
    for template_level in range(2):
        ...
        save_path = os.path.join(root_repo, f"provider/poses/predefined_poses/idx_all_level{template_level}_in_level2.npy")
    ...
    save_path = os.path.join(root_repo, "provider/poses/predefined_poses/idx_all_level2_in_level2.npy")
